...
python ./apsviz_station_products.py --fort63_style --url "$URL" --ndays -2  --return_sample_min 60 --gridname "$GRID" --ensemble='nowcast'  --map_file './AST_gridstations/full_stationlist/grid_to_stationfile_maps.yml' --contrails_auth ./secrets/contrails.yml --finalDIR "$FINALDIR" 
